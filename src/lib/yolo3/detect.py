...
from lib.yolo3.utils.datasets import *
...
if __name__ == "__main__":
    ...
    parser.add_argument("--image_folder", type=str, default="./lib/yolo3/data/custom/images", help="path to dataset")
    ...
    parser.add_argument("--class_path", type=str, default="./lib/yolo3/data/custom/classes.names", help="path to class label file")
